...
metab <- readRDS('//smb-main.ad.bcm.edu/genepi3/JeremySchraw/TINMAN/Datasets/TINMAN_merged_feces_raw_data_prospective_samples.rds')
...
saveRDS(metab, 
        paste0('TINMAN_prospective_merged_metab_imputed_unscaled_', format(Sys.Date(), '%Y%m%d'), '.rds'))
...
saveRDS(metab,
        paste0('TINMAN_prospective_merged_metab_imputed_autoscaled_', format(Sys.Date(), '%Y%m%d'), '.rds'))
