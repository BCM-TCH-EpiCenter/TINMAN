...
require(tidyverse); require(ggrepel); require(readxl)
...
counts <- readRDS('TINMAN_merged_metabolite_detection_counts_20230608.rds')
...
svg('volcano_plot_controls_unscaled_20230608.svg', height = 8, width = 8)

volcano(control, 'CONTROLS', 0.005)

dev.off()

svg('volcano_plot_neutropenic_unscaled_20230608.svg', height = 8, width = 8)
